...
Namespace Buscador.Tiendas
    Module GamesplanetFR
        ...
        Private Sub Bw_DoWork(sender As Object, e As DoWorkEventArgs) Handles bw.DoWork
            ...
            Try
                Dim html_ As Task(Of String) = HttpClient(New Uri("https://fr.gamesplanet.com/api/v1/products/feed.xml"))
                            ...
                            For Each juego In listaJuegos.Juegos
                                If Limpieza.Limpiar(juego.Titulo) = Limpieza.Limpiar(titulo) Or id = juego.SteamID Then
                                    ...
                                    If Not precio = String.Empty Then
                                        ...
                                        nuevaTienda = New Tienda(pepeizq.Editor.pepeizqdeals.Referidos.Generar(enlace), precio, "Assets/Tiendas/gamesplanet3.png", Nothing, "fr")
                                    End If
                                End If
                            Next
                        End If
