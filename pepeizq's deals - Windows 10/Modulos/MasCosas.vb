...
Module MasCosas
    ...
    Dim codigoFuente As String = "https://github.com/pepeizq/pepeizqs-deals-win10"
    Dim traduccion As String = Nothing
    Dim calificar As Boolean = True
    Dim youtube As String = "https://www.youtube.com/watch?v=uF6zm8cTakE"
    Dim pepeizqapps As Boolean = True
    Dim pepeizqdeals As Boolean = False
