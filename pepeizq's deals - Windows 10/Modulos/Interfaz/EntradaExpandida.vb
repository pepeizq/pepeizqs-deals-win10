...
Namespace Interfaz
    Module EntradaExpandida
        ...
        Public Sub Generar(json As EntradaOfertas)
            ...
            GenerarListado(json, cbOrdenarEntradaExpandida.SelectedIndex)
        ...
        Private Sub CambiarOrdenarListado(sender As Object, e As SelectionChangedEventArgs)
            ...
            GenerarListado(json, cb.SelectedIndex)

        End Sub

        Private Sub GenerarListado(json As EntradaOfertas, ordenado As Integer)
